...
try:
    from ljfortranpomp import ljfortranpomp as ljfortran
...
class PairLennardJonesCutFp(PairLennardJonesCut):
    ...
    def potential_and_force(self, system):
        ...
        particles = system.particles
        box = system.box
        forces, virial, vpot = ljfortran.potential_and_force(
            particles.pos,
            box.length,
            box.ilength,
            self._lj[1],
